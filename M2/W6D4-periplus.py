...
if figura_1 == 1:
    ...
    print("Se il numero che mi hai dato fosse il raggio di un cerchio, la sua circonferenza sarebbe " + str(round(circonferenza, 2)) + " e la sua area " + str(round(area, 2)))
    print("Scegli una nuova figura:\n")
    print(" 1. Quadrato")
    print(" 2. Triangolo (equilatero)\n")
    ...
    round_area_tri = round(area_tri, 2)
    area = round_area_tri

    print("Se il numero che mi hai dato fosse il lato di un triangolo equilatero, il suo perimetro sarebbe " + str(perimetro_tri) + " e la sua area " + str(round_area_tri))
    print("Scegli una nuova figura:\n")
    print(" 1. Quadrato")
    print(" 2. Cerchio\n")
