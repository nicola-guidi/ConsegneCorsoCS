...
Soluzione:
bashcd Castle/Main_tower/Top_of_the_tower
...
Soluzione:
bashcp *tapestry* ../../Forest/Hut/Chest/
...
Soluzione:
bashalias journal='nano ~/Forest/Hut/Chest/journal.txt'
...
Soluzione:
bashcomando1 && comando2 && comando3
...
bash# Una volta trovato il file
...
Soluzione:
bashtail -n 9 Book_of_potions/page_12
...
Soluzione:
bashcat Book_of_potions/page_01 Book_of_potions/page_02
...
Soluzione:
bashcat Book_of_potions/page_03 Book_of_potions/page_04 | tail -n 16
...
Soluzione:
bashhead -n 6 Book_of_potions/page_13 | tail -n 3
...
Soluzione:
bashls grimoire* > Drawer/inventory.txt
...
Soluzione:
bashfind -type f | xargs grep "diamond"
...
Soluzione:
bashls | grep -v <pattern_da_escludere>
...
Soluzione:
bashls | grep -v boring | xargs grep -v "PAID" | wc
